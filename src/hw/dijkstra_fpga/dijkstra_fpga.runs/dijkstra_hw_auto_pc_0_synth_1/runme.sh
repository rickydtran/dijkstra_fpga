...
HD_PWD='/mnt/windows/Users/ricky/Seafile/Library/School/F17/EEL4720/prj/dijkstra_fpga/src/hw/dijkstra_fpga/dijkstra_fpga.runs/dijkstra_hw_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dijkstra_hw_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dijkstra_hw_auto_pc_0.tcl
