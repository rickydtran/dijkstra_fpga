...
HD_PWD='/mnt/windows/Users/ricky/Seafile/Library/School/F17/EEL4720/prj/dijkstra_fpga/src/hw/dijkstra_fpga/dijkstra_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dijkstra_hw_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dijkstra_hw_wrapper.tcl
