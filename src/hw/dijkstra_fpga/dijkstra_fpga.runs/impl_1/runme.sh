...
HD_PWD='/mnt/windows/Users/ricky/Seafile/Library/School/F17/EEL4720/prj/dijkstra_fpga/src/hw/dijkstra_fpga/dijkstra_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dijkstra_hw_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dijkstra_hw_wrapper.tcl -notrace
